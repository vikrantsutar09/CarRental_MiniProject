...
<div class="flex-column">
  ...
  >
    <path
      d="M391 351c-12-12-24-12-36 0l-24 24c-6 6-12 6-18 0l-99-99c-6-6-6-12 0-18l24-24c12-12 12-24 0-36l-60-60c-12-12-24-12-36 0l-30 30c-18 18-18 48 0 66l174 174c18 18 48 18 66 0l30-30c12-12 12-24 0-36z"
    />
  </svg>
  <input type="text" class="input" placeholder="Enter your Phone Number" required />
</div>


    <button class="button-submit">Sign Up</button>  
    <p class="p">Don't have an account? <span class="span"><a href="./login.php">Login</a></span>
